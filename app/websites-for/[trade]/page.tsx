...
export default async function TradePage({ params }: Props) {
  ...
  return (
    <main>
      ...
      <PageHeader compact eyebrow={t.eyebrow} title={t.h1} body={t.lede} />
      ...
      <section className="py-20 sm:py-24">
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          ...
          <Reveal className="mt-14 max-w-2xl">
            <span className="font-mono text-[11px] uppercase tracking-[0.25em] text-blueprint">What it needs</span>
          ...
          <Reveal stagger className="mt-10 grid gap-5 md:grid-cols-2">
            {t.mustHave.map((m, i) => (
              <div key={m.title} className="rounded-2xl border border-border bg-card/40 p-7">
      ...
      <section className="border-t border-border py-20 sm:py-24">
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr] lg:gap-16">
            <Reveal>
              <span className="font-mono text-[11px] uppercase tracking-[0.25em] text-blueprint">How I build it</span>
              <h2 className="mt-4 font-display text-balance text-3xl font-bold tracking-tight sm:text-4xl">
            ...
            <Reveal delay={0.1}>
              <ul className="space-y-4">
                {[
                  `Landing page from £${PRICES.landing}`,
